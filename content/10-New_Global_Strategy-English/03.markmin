...
You have to an extent tried both socialism and capitalism and while neither of these systems has been implemented in any sort of pure form without considerable ‘cronyism’ you have identified that both have significant challenges.  The way forward definitely requires improved linking of performance and benefits for all individuals with agreed performance standards being established for different tasks.
